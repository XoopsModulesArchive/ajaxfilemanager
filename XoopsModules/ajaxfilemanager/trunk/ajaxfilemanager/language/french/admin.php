...
define("_AJAXFM_AM_INDEX_SCONFIG", "<strong>Information taken from Module Preferences:</strong>");
define("_AJAXFM_AM_INDEX_NOIFRAME", "Désolé, votre navigateur n'accepte pas les iframes.");
define("_AJAXFM_AM_WARNING_DIRNOTEXIST", "<strong style='color:red;'>ATTENTION: le dossier %s n'existe pas !</strong>");
define("_AJAXFM_AM_WARNING_DIRCREATEIT", "Créez le !");
define("_AJAXFM_AM_DIRCREATED", "Dossier %s créé !");
define("_AJAXFM_AM_DIRNOTCREATED", "<strong style='color:red;'>ATTENTION : le dossier %s n'a pas été créé !</strong>");

define("_AJAXFM_MI_FTPSUPPORT", "Support FTP");
define("_AJAXFM_AM_INDEX_SERVERSTATUS", "Statut du serveur");
define("_AJAXFM_AM_INDEX_SPHPINI", "<strong>Information du fichier PHP ini:</strong>");
...
define("_AJAXFM_AM_INDEX_SAFEMODEPROBLEMS", " (Ceci peut être à l'origine de problème)");
...
define("_AJAXFM_AM_INDEX_GDON", "<strong>Activé</strong>");
define("_AJAXFM_AM_INDEX_GDOFF", "<strong>Désactivé</strong>");
define("_AJAXFM_AM_INDEX_ZIPON", "<strong>Activ&eacute;</strong>");
define("_AJAXFM_AM_INDEX_ZIPOFF", "<strong>Désactivé</strong>");
define("_AJAXFM_AM_INDEX_OFF", "<strong>OFF</strong>");
define("_AJAXFM_AM_INDEX_ON", "<strong>ON</strong>");
...
//define('_AJAXFM_AM_PERM_UPLOAD',"Fichiers uploadés");
...
define("_AJAXFM_AM_PERM_EXTRA_1", "<strong>Utiliser Ajax File Manager</strong>");
...
define("_AJAXFM_AM_PERM_EXTRA_32", "Créer un dossier");
...
define("_AJAXFM_AM_PERM_EXTRA_512", "Créer un nouveau fichier");
define("_AJAXFM_AM_PERM_EXTRA_1024", "Zipper les fichiers/dossiers");
define("_AJAXFM_AM_PERM_EXTRA_2048", "Dézipper les fichiers");
...
define("_AJAXFM_AM_EXTENSION_NOT_INSTALLED", "Extension non installé");
define("_AJAXFM_AM_EXTENSION_NOT_ACTIVATED", "Extension non activé");
define("_AJAXFM_AM_INSTALL_EXTENSION", "Installer l'extension");
define("_AJAXFM_AM_ACTIVATE_EXTENSION", "Activer l'extension");
define("_AJAXFM_AM_EXTENSION_ACTIVATED", "Extension activée");
define("_AJAXFM_AM_DISABLE_EXTENSION", "Désactiver l'extension");
define("_AJAXFM_AM_EXTENSION_DISABLED", "Extension désactivée");
define("_AJAXFM_AM_EXTENSION_INSTALLED_OK", "Extension installée");
define("_AJAXFM_AM_EXT_FILE_NOT_INSTALLABLE", "Extension non installée");
define("_AJAXFM_AM_EXTENSION_ACTIVATED_OK", "Extension activatée");
define("_AJAXFM_AM_EXTENSION_NOTICE", "This extension allow you to display images on all the site just by adding a <strong>vidéo</strong> tag to your text. A button (<img src=\"../images/image_button.png\" />) is displayed on XOOPS editor.");
define("_AJAXFM_AM_EXT_FILE_DONT_EXIST", "Le fichier d'extension n'existe pas dans le dossier :<br /><strong>Serveur : </strong>%s<br /><strong>Fichier : </strong>%s");
define("_AJAXFM_AM_EXT_FILE_DONT_EXIST_SHORT", "Le fichier d'extension n'existe pas");
define("_AJAXFM_AM_EXTENSION_INSTALLED", "Extension installée");
...
define("_AJAXFM_AM_ABOUT_CREDITS", "Crédits");
define("_AJAXFM_AM_ABOUT_LICENSE", "License");
define("_AJAXFM_AM_ABOUT_MODULEINFOS", "Informations sur le module");
define("_AJAXFM_AM_ABOUT_MODULEWEBSITE", "Site internet du support");
define("_AJAXFM_AM_ABOUT_AUTHORINFOS", "Informations sur l'auteur");
define("_AJAXFM_AM_ABOUT_AUTHORWEBSITE", "Site Internet");
define("_AJAXFM_AM_ABOUT_AUTHOREMAIL", "Adresse email");
