...
foreach($views as $k=>$v) {
    echo '<input type="radio" name="view"  class="radio" onclick="changeView(this);" value="' . $k . '" ' . ($k==$view?'checked':'') . '> ' . $v . '&nbsp;&nbsp;';
}
?>
</div>
...
<fieldset class="boxSearch">
    ...
    <tbody>
        ...
        <tr>
            <td >
                <b><?php echo LBL_SEARCH_FOLDER; ?></b>
                <br />
        ...
        <div class="jqmBody">
            <form id="formRename" name="formRename" method="POST" action="">
                ...
                <th><label><?php echo RENAME_NEW_NAME; ?></label></th>
                    <td><input type="name" id="renameName" class="input" name="name" style="width:250px" /></td>
                </tr>
                </tbody>
                <tfoot>
                <tr>
    ...
    <div class="jqmContainer">
        ...
        <div class="jqmBody">
            ...
            <tr>
                ...
                <td><a href="http://www.phpletter.com/forum/">http://www.phpletter.com/forum/</a></td>
            </tr>
            <tr>
                <th nowrap><label>&copy;Copyright:</label></th>
                <td>All copyright declarations in the source must remain unchange. Please contact us if you need to make changes to it, in order to avoid any Legal Issues.</td>
            </tr>
            </tbody>
            </table>
        </div>
