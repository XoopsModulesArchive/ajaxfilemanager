                ...
                default:
                    ...
                    switch(files[num].cssClass) {
                        case 'filePicture':
                            ...
                            break;
                        case 'fileCode':
                        case 'fileHtml': /* for Xoops */
                            menusToRemove[menusToRemove.length] = '#menuPlay';
                            menusToRemove[menusToRemove.length] = '#menuUnzip';
                            break;
                        case 'fileVideo':
                        case 'fileFlash':
                        case 'fileSwf': /* for Xoops */
                        case 'fileFlv': /* for Xoops */
                        case 'fileAcrobat': /* for Xoops */
                        case 'fileMusic':
                        case 'fileMp3': /* for Xoops */
                            menusToRemove[menusToRemove.length] = '#menuPreview';
                            menusToRemove[menusToRemove.length] = '#menuEdit';
                            menusToRemove[menusToRemove.length] = '#menuUnzip';
                            break;
                        case 'fileZip': /* for Xoops */ // IN PREGRESS
                            menusToRemove[menusToRemove.length] = '#menuPreview';
                            menusToRemove[menusToRemove.length] = '#menuEdit';
                            menusToRemove[menusToRemove.length] = '#menuPlay';
                            break;
...
function checkAll(checkbox)
{
    if($(checkbox).attr('class') == "check_all") {
        ...
        switch(getView()) {
            ...
            case 'detail':
            default:
                $("#fileList tr[@id^=row] input[@type=checkbox]").each(
                    function(i){
                        $(this).attr("checked", 'checked');
                    }
                );
