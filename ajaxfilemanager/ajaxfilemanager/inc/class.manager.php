...
class manager
{
	...
	var $fileTypes = array(
			...
			array(array('php', 'jsp', 'asp', 'js', 'css'), 'fileCode', SEARCH_TYPE_HTML, 1),
			array(array('htm', 'html'), 'fileHtml', SEARCH_TYPE_HTML, 1), /* for Xoops */
			array(array('mov', 'ram', 'rm', 'asx', 'dcr'), 'fileVideo', SEARCH_TYPE_VIDEO, 1),
			array(array('wma', 'wmv'), 'fileVideo', SEARCH_TYPE_VIDEO, 1), /* for Xoops */
			array(array('mpg', 'avi', 'asf', 'mpeg'), 'fileVideo', SEARCH_TYPE_MOVIE, 1),
			array(array('aif', 'aiff', 'wav', 'wma'), 'fileMusic', SEARCH_TYPE_MUSIC, 1),
			array(array('mp3'), 'fileMp3', SEARCH_TYPE_MUSIC, 1), /* for Xoops */
			//array(array('swf'), 'fileFlash', SEARCH_TYPE_FLASH, 1),
			array(array('swf'), 'fileSwf', SEARCH_TYPE_FLASH, 1),
			array(array('flv'), 'fileFlv', SEARCH_TYPE_FLASH, 1), /* for Xoops */
			...
			array(array('kml'), 'fileKml', SEARCH_TYPE_KML, 1) /* for Xoops */
	);
