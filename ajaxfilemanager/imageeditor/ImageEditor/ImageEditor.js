...
ImageEditor.processImage = function(args){
	...
	request.open("POST", "ImageEditor/processImage.php", true);
...
ImageEditor.loadImage = function(){
	ImageEditor.loaderImage.setAttribute("src", "ImageEditor/getImage.php?imageName=" + ImageEditor.imageName + "&t=" + (new Date).getTime());
};
...
ImageEditor.init = function(imageName, elementId){

    ImageEditor.imageName = imageName || "";
    ImageEditor.editorImage = document.getElementById(elementId);
